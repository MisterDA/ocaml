(* TEST
 readonly_files = "gcc-9.sh cxx-api.sh filter.jq all-includes.h stubs.c";
 ...
 script;
 {
   ...
   script = "sh ${test_source_directory}/cxx-api.sh ${cc} -xc++ -std=c++11 -I ${ocamlsrcdir}/runtime -I ${ocamlsrcdir}/otherlibs/runtime_events -I ${ocamlsrcdir}/otherlibs/str -I ${ocamlsrcdir}/otherlibs/systhreads -I ${ocamlsrcdir}/otherlibs/unix -o stubs.o -c stubs.c";
   script;
...
Some compilers (e.g., Apple clang's 15 and before) default to an old
...
easier to filter non-avoidable errors. *)
