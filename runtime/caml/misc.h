...
#ifdef CAML_INTERNALS
#undef unreachable /* C23 defines unreachable() as a macro in <stddef.h> */
  ...
  #define unreachable() (caml_fastfail(7 /* FAST_FAIL_FATAL_APP_EXIT */))
#else
  #define unreachable() (CAMLassert(0))
#endif
#endif
